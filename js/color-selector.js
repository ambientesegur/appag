document.addEventListener('DOMContentLoaded', function() {
  ...
  const colorToImageMapping = {
    'Preto': '26382685798509',
    'Vermelho': '26382685864045',
    'Prata': '26382685929581'
  };
  ...
  const checkedRadio = document.querySelector('.variant-swatch__radio[name="option1"]:checked');
  if (checkedRadio) {
    updateColorSelection(checkedRadio);
  }
